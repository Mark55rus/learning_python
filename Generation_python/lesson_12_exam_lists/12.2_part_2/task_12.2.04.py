...
s = ''.join(lst)
if 3 <= len(lst) <= 4 and s.isdigit():
    if len(lst) == 3:
        if len(str(lst[0])) == 3 and len(str(lst[1])) == 3 and len(str(lst[2])) == 4:
            print('YES')
        else:
            print('NO')
    elif len(lst) == 4:
        if int(lst[0]) == 7 and len(str(lst[1])) == 3 and len(str(lst[2])) == 3 and len(str(lst[3])) == 4:
            print("YES")
        else:
            print('NO')
else:
