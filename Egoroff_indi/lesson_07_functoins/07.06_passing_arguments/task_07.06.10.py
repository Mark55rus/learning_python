...
assert replace('Нет', 'т')
assert replace('Bella Ciao', 'a')
assert replace('nobody; i myself farewell analysis', 'l', 'z')
assert replace('commend me to my kind lord meaning', 'M', 'w')
print('OK')
