...
def fibonacci(n):
    ...
    return fibonacci(n - 1) + fibonacci(n - 2)
        Проблема работы этой функции в том, что она постоянно будет вызывать одни и те же значения, что будет сказываться
на скорости работы. Если вызвать ее от десяти
print(fibonacci(10))
...
производительность рекурсивных функций, которые в противном случае могут привести к многократному выполнению одних и
тех же вычислений.
