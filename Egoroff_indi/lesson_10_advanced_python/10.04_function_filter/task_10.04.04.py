...
negative_value = len(list(filter(lambda x: x < 0, numbers)))
zero_value = len(list(filter(lambda x: x == 0, numbers)))
positive_value = len(list(filter(lambda x: x > 0, numbers)))
print(negative_value, zero_value, positive_value)